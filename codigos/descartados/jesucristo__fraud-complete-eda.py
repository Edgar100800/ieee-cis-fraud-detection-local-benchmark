"""
NOTEBOOK: jesucristo__fraud-complete-eda
...
TECNICAS DETECTADAS:
  - LightGBM (1 menciones)
  - XGBoost (8 menciones)
  - CatBoost (1 menciones)
  - GPU (device=cuda/gpu) (2 menciones)
  - KFold / StratifiedKFold (2 menciones)
  - Label encoding (1 menciones)
  - Frequency encoding (11 menciones)
  - Reduccion de memoria (10 menciones)
  - EDA con plotly (13 menciones)
  - EDA con matplotlib/seaborn (105 menciones)
"""
