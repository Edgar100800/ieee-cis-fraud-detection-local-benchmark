"""
NOTEBOOK: kyakovlev__ieee-gb-2-make-amount-useful-again

SECCIONES (markdown del notebook):


TECNICAS DETECTADAS:
  - LightGBM (5 menciones)
  - KFold / StratifiedKFold (1 menciones)
  - Feature agregacion (groupby) (2 menciones)
  - UID / magic client (22 menciones)
  - Label encoding (2 menciones)
  - Frequency encoding (3 menciones)
  - Log transform amount (2 menciones)
"""
