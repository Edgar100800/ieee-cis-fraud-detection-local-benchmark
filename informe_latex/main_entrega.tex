...
selección de ventana debe apoyarse en métricas de desempeño y costo. El código reproducible se
encuentra en \texttt{src/adaptive\_fraud.py} y los resultados en
