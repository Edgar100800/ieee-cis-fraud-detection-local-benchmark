...
\begin{enumerate}
  \item \textbf{Protocolo transductivo}: las agregaciones por UID se computan sobre todo el
        ...
        sistema causal estricto. Esa brecha dejó de ser hipotética: en el sistema integrado del
        notebook 05, la variante estricta midió $0{,}9175$ frente a $0{,}9456$ del protocolo
        original (\cref{sec:costo-causalidad}).
  ...
  \item \textbf{Métrica única}: el AUC ordena bien pero no responde por costos asimétricos de
        ...
        métrica de utilidad propios. La medición de umbrales fijos y calibrados del sistema
        integrado cubre parte de esa falta (\cref{sec:costo-causalidad}).
\end{enumerate}
